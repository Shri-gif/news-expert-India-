...
NEWS_SOURCES = [
    {
        ...
        "url": lambda key: f"https://newsapi.org/v2/everything?q=India&domains=thehindu.com,timesofindia.indiatimes.com,economictimes.indiatimes.com&language=en&sortBy=publishedAt&pageSize=10&apiKey={key}"
    }
